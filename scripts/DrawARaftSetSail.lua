...
task.spawn(function()
    while true do
        local args1 = {{type="SeaCreature", rarity="Common", creatureId=1, color=Color3.new(0.83,0.83,0.83), value=1, icon="🐋", displayName="Mosasaurus"}}
        game:GetService("ReplicatedStorage"):WaitForChild("GrantReward"):InvokeServer(unpack(args1))

        local args2 = {{type="Money", rarity="Common", color=Color3.new(0.83,0.83,0.83), value=2000, icon="💰", displayName="10,000 Cash"}}
